...
const ResultSuccess: React.FC = () => {
  const desc1 = (
    <div style={{ margin: '8px 0 4px' }}>
      ...
      <div style={{ fontSize: 12, color: 'rgba(0,0,0,0.45)' }}>2016-12-12 12:32</div>
    </div>
  )
  ...
  const desc2 = (
    <div style={{ margin: '8px 0 4px', fontSize: 12 }}>
      ...
      <a style={{ marginLeft: 8 }}>
        <DingdingOutlined style={{ color: '#00A0E9' }} />
        <span style={{ marginLeft: 4 }}>催一下</span>
      </a>
    </div>
  )
  ...
  const extra = (
    <>
      ...
      <Button style={{ marginLeft: 8 }}>查看项目</Button>
      <Button style={{ marginLeft: 8 }}>打印</Button>
    </>
  )
